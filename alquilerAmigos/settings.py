"""
Django settings for alquilerAmigos project.
...
SECRET_KEY = 'django-insecure-cu$aj3=0s!ht8dnr7gsgvhcp07st$rvwbz#^+$9rvu4fn#p(_&'
...
ROOT_URLCONF = 'alquilerAmigos.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'inicio.context_processors.usuarioLog',
            ],
        },
    },
]

WSGI_APPLICATION = 'alquilerAmigos.wsgi.application'
